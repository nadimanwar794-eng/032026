...
function getDeploymentDomain() {
  ...
  console.log(
    "No deployment domain found (REPLIT_INTERNAL_APP_DOMAIN, REPLIT_DEV_DOMAIN, EXPO_PUBLIC_DOMAIN). Skipping mobile build — this build only runs in a Replit environment.",
  );
  process.exit(0);
}
