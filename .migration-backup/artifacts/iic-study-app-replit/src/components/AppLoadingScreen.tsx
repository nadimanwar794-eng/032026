    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-md">
        <div className="w-52 h-52 sm:w-60 sm:h-60 flex items-center justify-center">
          <img
            src={`${import.meta.env.BASE_URL}splash-logo.png`}
            alt="NSTA National Study and Tracking App logo"
            className="h-full w-full object-contain drop-shadow-[0_0_26px_rgba(255,255,255,0.22)]"
            fetchPriority="high"
          />
        </div>

        <div className="flex items-center justify-center gap-2.5 mt-1 text-xs font-bold flex-wrap">
        ...
        <div className="relative z-10 w-[345px] h-[345px] flex items-center justify-center my-auto">
          ...
          >
             <img
               src={`${import.meta.env.BASE_URL}splash-logo.png`}
               alt="NSTA logo"
               className="w-28 h-28 rounded-2xl object-contain drop-shadow-[0_0_18px_rgba(255,255,255,0.3)]"
             />
