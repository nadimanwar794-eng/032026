...
export const getUserTier = (
  ...
  // Admin/Sub-admin always get ultra tier theme — tier color changes by admin must not affect their own view
  if ((user as any).role === 'ADMIN' || (user as any).role === 'SUB_ADMIN') return 'ultra';
